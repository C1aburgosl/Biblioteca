package biblio;
import java.io.*;
public class NodoLibroUsuario implements Serializable{
	private NodoLibroUsuario inicio;
	private int tamaño;
	private NodoLibroUsuario siguiente;
	
	public NodoLibroUsuario(){
		inicio = null;
		tamaño = 0;
	}
	...
	public NodoLibroUsuario getSiguiente() {
		return siguiente;
	}

	public void setSiguiente(NodoLibroUsuario siguiente) {
